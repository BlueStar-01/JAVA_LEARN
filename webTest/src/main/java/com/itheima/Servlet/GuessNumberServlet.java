...
import com.itheima.entiy.GuessGame;
...
public class GuessNumberServlet extends HttpServlet {
    private static final String INPUT_URL = "/input.jsp";
    private static final String INVALID_GUESS_MESSAGE = "猜测的数字必须在0到100之间。";
    private static final String GAME_OVER_URL = "/game_over.jsp";
    private static final String NO_MESSAGE = ""; // 或者您可以设置一个默认的空消息
